      ...
      <Container className="flex min-h-[calc(100vh-3.5rem)] items-center justify-center py-16">
        <div className="w-full max-w-sm">
          ...
          <div className="mt-8 space-y-3">
            ...
            {!enabledProviders.google && !enabledProviders.email && (
              <p className="rounded-md border border-border bg-card p-3 text-center text-[12px] text-accent">
                Google &amp; email sign-in turn on automatically once their env
                vars are set. Wallet sign-in works out of the box.
              </p>
            )}
          </div>
